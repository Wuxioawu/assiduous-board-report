...
| Visualization | **Recharts** (standard charts) + **Plotly** (complex interactive charts, e.g. cash bridge) | |
...
- Four audience-based dashboard views with real charts (Recharts/Plotly)
- Audit log
