...
_DEFINITIONS = [
    # Growth
    MetricDefinition("revenue", "Revenue", MetricCategory.GROWTH, MetricUnit.CURRENCY),
    ...
    MetricDefinition("ebitda", "EBITDA", MetricCategory.PROFITABILITY, MetricUnit.CURRENCY),
    MetricDefinition(
